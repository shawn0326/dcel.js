!function(e, t) {
    ...
    var E = function(e) {
        var t, n, r, i, o, a, s, u, l, c, f, p, d, h, g, v, y, m, x, b = "sizzle" + 1 * new Date, w = e.document, T = 0, C = 0, E = ue(), k = ue(), S = ue(), A = ue(), N = function(e, t) {
            return e === t && (f = !0),
            0
        ...
        s = se.compile = function(e, t) {
            ...
            if (!v) {
                ...
                c = function(e, t, n, a, c) {
                    var f, h, v, y = 0, m = "0", x = e && [], b = [], w = l, C = e || u && r.find.TAG("*", c), E = T += null == w ? 1 : Math.random() || .1, k = C.length;
    ...
    w.each({
        ...
        w.fn[e] = function(n, r) {
            ...
            1 < this.length && (O[e] || w.uniqueSort(i),
            H.test(e) && i.reverse()),
            this.pushStack(i)
        }
    }
        ...
        w.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    r = n(this, t),
                    this[t](),
                    a !== (i = Q.get(this, t)) || r ? Q.set(this, t, !1) : i = void 0,
                    a !== i)
                        return e.stopImmediatePropagation(),
                        e.preventDefault(),
                        i
                } else
                    a && (Q.set(this, t, w.event.trigger(w.extend(a.shift(), w.Event.prototype), a, this)),
    ...
    function Ie(e, t, n, r) {
        ...
        o || r)) {
            ...
            if (u)
                ...
                f = 0; f < u; f++)
                    l = s[f],
                    he.test(l.type || "") && !Q.access(l, "globalEval") && w.contains(c, l) && (l.src && "module" !== (l.type || "").toLowerCase() ? w._evalUrl && !l.noModule && w._evalUrl(l.src, {
    ...
    w.each(["height", "width"], (function(e, t) {
        w.cssHooks[t] = {
            get: function(e, n, r) {
                if (n)
                    return !Ye.test(w.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? tt(e, t, r) : ue(e, Je, (function() {
                        return tt(e, t, r)
                    }
                    ))
            },
            set: function(e, n, r) {
                var i, o = Fe(e), a = !h.scrollboxSize() && "absolute" === o.position, s = (a || r) && "border-box" === w.css(e, "boxSizing", !1, o), u = r ? et(e, t, r, s, o) : 0;
    ...
    function lt() {
        it && (!1 === r.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(lt) : e.setTimeout(lt, w.fx.interval),
        w.fx.tick())
    }
    function ct() {
    ...
    w.extend(w.event, {
        trigger: function(t, n, i, o) {
            ...
            if (s = h = u = i = i || r,
            3 !== i.nodeType && 8 !== i.nodeType && !Tt.test(m + w.event.triggered) && (-1 < m.indexOf(".") && (m = (x = m.split(".")).shift(),
            x.sort()),
            c = m.indexOf(":") < 0 && "on" + m,
    ...
    w.parseHTML = function(e, t, n) {
        ...
        a = !n && [],
        (o = D.exec(e)) ? [t.createElement(o[1])] : (o = we([e], t, a),
